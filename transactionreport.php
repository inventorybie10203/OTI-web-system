      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          <div class="card-header">
            <i class="fa fa-bar-chart"></i>Transaction Report</div>
            <div class="card-body">
              ...
              <form action="/action_page.php">
                ...
                <div class="row justify-content-center">
                  <div class="col-1">
                    <a class="btn btn-success" href="#" id="toggleNavPosition">Generate report</a>
                  </div>
                  <div class="col-1">
                    <a class="btn btn-primary" href="#" id="toggleNavPosition">Cancel</a>
                  </div>
                </div>
              </form>
            </div>
